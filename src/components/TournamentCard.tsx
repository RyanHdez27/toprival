...
import { TournamentShareModal } from "./ModalDialog";
...
export function TournamentCard({
  ...
  return (
    <>
      <div
        onClick={onClick}
        className="group bg-[#111113] border border-[#27272A] rounded-xl overflow-hidden hover:border-[#3F3F46] transition-all duration-200 cursor-pointer hover:shadow-[0_0_30px_#D4860A11] flex flex-col justify-between"
      >
        {/* Game banner */}
        <div className="relative h-28 bg-gradient-to-br from-[#18181B] to-[#0D0D0F] overflow-hidden">
          ...
          <div className="absolute top-3 right-3 flex items-center gap-1.5">
            <button
              title="Compartir torneo / Ver QR"
              onClick={(e) => {
                e.stopPropagation();
                setShowShareModal(true);
              }}
              className="w-7 h-7 rounded-lg bg-[#18181B]/90 hover:bg-[#D4860A] text-[#A1A1AA] hover:text-white border border-[#27272A] flex items-center justify-center transition-all cursor-pointer shadow-md"
            >
              <Icon.QrCode />
            </button>
        ...
        <div className="p-4 flex-1 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <Button
              ...
              className="px-2.5 text-xs border-[#27272A] hover:border-[#D4860A] text-[#A1A1AA] hover:text-[#FAFAFA]"
            >
              <Icon.Share />
            </Button>
          </div>
